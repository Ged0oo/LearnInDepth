...
{
		.USART_BaudRate = USART_CONFUGURED_BR,
		.USART_HWFlowControl = USART_CONFUGURED_HW_FLOW,
		.USART_Parity = USART_CONFUGURED_Parity,
		.USART_TXRX_State = USART_CONFUGURED_TXRX_STATE,
		.USART_WordLength = USART_CONFUGURED_WORD_LENGTH,
		.USART_StopBits = USART_CONFUGURED_STOP_BITS
};
