 ...
 * Created on February 6, 2024, 8:41 PM
 */
...
void MNVIC_xEnableInterrupt(IRQnum_t Copy_xIntIndex);
void MNVIC_xDisableInterrupt(IRQnum_t Copy_xIntIndex);

void MNVIC_xSetPendingFlag(IRQnum_t Copy_xIntIndex);
void MNVIC_xClearPendingFlag(IRQnum_t Copy_xIntIndex);

void MNVIC_xReadIntState(IRQnum_t Copy_xIntIndex, uint8 *pu8IntState);
IRQnum_t MNVIC_xCheck_CurrentInt(void);

void MSCB_vSetPriorityGroup(uint32 Copy_u32PriorityGroup);
uint32 MSCB_vGetPriorityGroup(void);
	
void MNVIC_xSetPriority(IRQnum_t Copy_xIntIndex , uint32 Copy_u8Priority);
uint32 MNVIC_xGetPriority(IRQnum_t Copy_xIntIndex);
